...
// *******************************************************************************************
int CArchive::register_stream(const string& stream_name)
{
...
int CArchive::RegisterStream(const string &stream_name)
{
	...
	return register_stream(stream_name);
}

// *******************************************************************************************
pair<int, int> CArchive::RegisterStreams(const string& stream_name1, const string& stream_name2)
{
	lock_guard<mutex> lck(mtx);

	int id1 = register_stream(stream_name1);
	int id2 = register_stream(stream_name2);
